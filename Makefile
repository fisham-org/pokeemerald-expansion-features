...
$(INCLUDE_DIRS)/constants/quests.h $(DATA_SRC_SUBDIR)/quests.h &: $(wildcard $(QUESTS_DATA_DIR)/*.json) $(QUESTS_TOOL_DIR)/quests_to_header.py $(INCLUDE_DIRS)/constants/quest_types.h
