...
const u16 gMetatiles_PrimaryPoc[] = INCBIN_U16("data/tilesets/primary/primary_poc/metatiles.bin");
const u16 gMetatileAttributes_PrimaryPoc[] = INCBIN_U16("data/tilesets/primary/primary_poc/metatile_attributes.bin");
