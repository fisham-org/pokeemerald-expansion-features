...
const u16 gMetatiles_PorytilesManaged_General_Porytiles[] = INCBIN_U16("data/tilesets/primary/general_porytiles/porytiles_bin/metatiles.bin");
const u16 gMetatileAttributes_PorytilesManaged_General_Porytiles[] = INCBIN_U16("data/tilesets/primary/general_porytiles/porytiles_bin/metatile_attributes.bin");
