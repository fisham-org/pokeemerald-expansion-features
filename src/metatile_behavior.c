...
static const u8 sTileBitAttributes[NUM_METATILE_BEHAVIORS] =
{
    ...
    [MB_PRAIRIE_LONG_GRASS]                 = TILE_FLAG_UNUSED | TILE_FLAG_HAS_ENCOUNTERS,
    [MB_PRAIRIE_TALL_GRASS]                 = TILE_FLAG_UNUSED | TILE_FLAG_HAS_ENCOUNTERS,
...
{
    if (metatileBehavior == MB_TALL_GRASS || metatileBehavior == MB_LONG_GRASS || metatileBehavior == MB_PRAIRIE_LONG_GRASS || metatileBehavior == MB_PRAIRIE_TALL_GRASS || metatileBehavior == MB_CYCLING_ROAD_PULL_DOWN_GRASS || metatileBehavior == MB_SWAMP_TALL_GRASS || metatileBehavior == MB_SWAMP_PLANTS)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsPrairieLongGrass(u8 metatileBehavior)
{
    if (metatileBehavior == MB_PRAIRIE_LONG_GRASS)
        return TRUE;
    else
        return FALSE;
}
...
{
    if (metatileBehavior == MB_LONG_GRASS || metatileBehavior == MB_PRAIRIE_LONG_GRASS)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsRunningDisallowed(u8 metatileBehavior)
{
    if (metatileBehavior == MB_NO_RUNNING
     ...
     || metatileBehavior == MB_PRAIRIE_LONG_GRASS
...
bool8 MetatileBehavior_IsCuttableGrass(u8 metatileBehavior)
{
    if (metatileBehavior == MB_TALL_GRASS
     || metatileBehavior == MB_LONG_GRASS
     || metatileBehavior == MB_PRAIRIE_LONG_GRASS
     || metatileBehavior == MB_PRAIRIE_TALL_GRASS
