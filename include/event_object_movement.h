...
#define GROUND_EFFECT_FLAG_PRAIRIE_LONG_GRASS_ON_SPAWN (1 << 20)
#define GROUND_EFFECT_FLAG_PRAIRIE_LONG_GRASS_ON_MOVE  (1 << 21)
#define GROUND_EFFECT_FLAG_LAND_IN_PRAIRIE_LONG_GRASS  (1 << 22)
...
#define GROUND_EFFECT_FLAG_SWAMP_TALL_GRASS_ON_SPAWN (1 << 26)
#define GROUND_EFFECT_FLAG_SWAMP_TALL_GRASS_ON_MOVE  (1 << 27)
#define GROUND_EFFECT_FLAG_LAND_IN_SWAMP_TALL_GRASS  (1 << 28)
#define GROUND_EFFECT_FLAG_SWAMP_PLANTS_ON_SPAWN    (1 << 29)
#define GROUND_EFFECT_FLAG_SWAMP_PLANTS_ON_MOVE     (1 << 30)
#define GROUND_EFFECT_FLAG_LAND_IN_SWAMP_PLANTS     (1 << 31)
