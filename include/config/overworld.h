...
// Time
#define OW_TIMES_OF_DAY                 GEN_9        // Different generations have the times of day change at different times.
...
#define OW_FLAG_PAUSE_TIME          FLAG_UNUSED_0x020  // If this flag is set and OW_USE_FAKE_RTC is enabled, seconds on the in-game clock will not advance.
